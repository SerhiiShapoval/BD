...
import OrderDetails from './components/OrderDetailsLazy';
import OrdersList from './components/OrdersList';
import OrderDetailsEager from './components/OrderDetailsEager';
    ...
    <Router>
      <div>
        ...
        <Switch>
          ...
          <Route path="/order/:id" component={OrderDetailsEager}/>
        </Switch>
      </div>
    </Router>
  );
